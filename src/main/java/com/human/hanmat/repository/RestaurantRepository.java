...
public interface RestaurantRepository extends JpaRepository<Restaurant, Long> {
    @Query(value = "SELECT * FROM (SELECT ROWNUM RN, T_RESTAURANT.* FROM HANMAT.T_RESTAURANT WHERE RESTAURANT_NAME LIKE '%' || ?1 || '%' ORDER BY RESTAURANT_NAME) WHERE RN BETWEEN 1 AND 10", nativeQuery = true)
